...
public class AVL<T> extends Node<T> {
    ...
    protected AVL<T> InsereOrdenado(T v, AVL<T> nodepai ) {
        ...
        if (v.toString().compareTo(this.getValor().toString())<0) {
            ...
            if (this.getFilho_esq()!=null) {
                this.getFilho_esq().InsereOrdenado(v,this);//senao for nulo continua navegando na arvore ate encontrar uma folha
                resultado = this.verificarbalanceamento(nodepai);//verifica balanceamento e rotaciona se necessario retornando a nova raiz.
    ...
    protected AVL<T> removerNode(T v, AVL<T> nodepai){
        ...
        if (comparacao<0){
            ...
            else return resultado;//o valor nao ta na subarvoreesquerda
        }
            ...
            else return resultado;//valor nao foi encontrado               }
        }
        ...
        if ((fb<-1)||(fb>1)){//verificar se ha desbalanceamento.
            if (fb>1) { //o lado direito é bem maior
                if (this.getFilho_dir()!=null) {
                    ...
                    else return this.rotacaoAEsquerda(nopai);
                }
                ...
                else return this.rotacaoADireita(nopai);
            }
        }
        return this;
    }
